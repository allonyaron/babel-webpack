...
var _testImport = __webpack_require__(1);

var mortgage = _interopRequireWildcard(_testImport);
...
var _mortgage$calculateAm = mortgage.calculateAmortization(20, 10, 5),
...
var JUNE2;
var nydnRequires = _require3.default.config({
    context: "nydn",
    baseUrl: "/nydn/js",
    waitSeconds: 10
});
...
//AOL
{
    ...
    rh.getAolVars = function () {
        ...
        if (!!document.querySelector("[id*='r-aol-video']")) {
            rh.aol.vars.aolVideoDivId = document.querySelector("[id*='r-aol-video']").id;
        }
    };
...
var oVa = oVa || {};
{
    ...
    rh.ads.optimera.targeting = function () {
        ...
        nydnRequires([nydn.urls.optimera], function (util) {
            ...
            if (!!document.querySelector("[id*='r-aol-video']")) {
                var aolVideoId = document.querySelector("[id*='r-aol-video']").id;
                oDv.push(["v", aolVideoId]);
                oVa[aolVideoId] = ["NULL"];
            }
...
(function (ha) {
    ...
    function Z(b, c, d, k) {
        c && E(c, function (c, g) {
            if (d || !w(b, g)) {
                !k || "object" !== (typeof c === "undefined" ? "undefined" : _typeof(c)) || !c || M(c) || L(c) || c instanceof RegExp ? b[g] = c : (b[g] || (b[g] = {}), Z(b[g], c, d, k));
            }
        });
        return b;
    }
    ...
    function ma(b) {
        ...
        function p(a) {
            var n = g(m.paths, a);
            if (n && M(n) && 1 < n.length) {
                return n.shift(), h.require.undef(a), h.makeRequire(null, {
                    skipMap: !0
                })([a]), !0;
            }
        }
        ...
        function K(a, b, c) {
            var f = a.map.id;
            a.error ? a.emit("error", a.error) : (b[f] = !0, x(a.depMaps, function (f, d) {
                var h = f.id,
                    k = g(t, h);
        ...
        function I() {
            var a,
                b,
                c = (a = 1000 * m.waitSeconds) && h.startTime + a < new Date().getTime(),
                f = [],
                l = [],
                k = !1,
                g = !0;
                ...
                E(aa, function (a) {
                    ...
                    if (a.enabled && (h.isDefine || l.push(a), !a.error)) {
                        if (!a.inited && c) {
                            ...
                            if (!a.inited && a.fetched && h.isDefine && (k = !0, !h.prefix)) {
                                return g = !1;
                            }
                        }
                    }
            ...
            callPlugin: function callPlugin() {
                ...
                v(d, "defined", y(this, function (f) {
                    ...
                    if (this.map.unnormalized) {
                        ...
                        e ? (this.map.url = h.nameToUrl(e), this.load()) : (l = y(this, function (a) {
                            this.init([], function () {
                                return a;
                            }, null, {
                                enabled: !0
    ...
    if ("undefined" === typeof define) {
        ...
        "undefined" === typeof _require || L(_require) || (v = _require, _require = void 0);
        k = requirejs = function requirejs(b, c, d, p) {
            var e,
                q = "_";
        ...
        F && !v.skipDataMain && Y(document.getElementsByTagName("script"), function (b) {
            ...
            if (P = b.getAttribute("data-main")) {
                return u = P, v.baseUrl || (J = u.split("/"), u = J.pop(), U = J.length ? J.join("/") + "/" : "./", v.baseUrl = U), u = u.replace(V, ""), k.jsExtRegExp.test(u) && (u = P), v.deps = v.deps ? v.deps.concat(u) : [u], !0;
            }
        });
